  ...
  return (
    ...
    <div id="video">
          <div className={classes.title}>
              ...
              {(CoTwoInfo) ?
              <h3>Futurescape GAN = a  {(CoTwoInfo > co2Thresh) ? `bleak future based on ${CoTwoInfo}kg above` : `more homogenous future based on ${CoTwoInfo}kg at or below`} a goal of 12.32kg daily emissions. </h3> : <h3></h3>}
