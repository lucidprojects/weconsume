      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={12}>
          <h5 className={classes.description}>
            ...
            <br /><br />   
            The weconsu.me website is my first attempt at a reactjs site. Built on a Material UI template, It accesses the block explorer API and uses several components to display the futurescape GAN animations based on my consumption. There is also a simplified tool to allow other users to quantify their emissions. A p5 sketch and the RunwayML hosted model API will enable them to generate a styleGAN still based on their emissions.  The p5 sketch code was based on Roy Macdonald’s awesome <a href="https://github.com/roymacdonald/roymacdonald.github.io/blob/master/stylegan-transition.js" target="_blank" rel="noopener noreferrer">tyleGan mixer</a>s.
            <br /><br />   
